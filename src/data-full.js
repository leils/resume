const data = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        "Project lead for internal tooling feature releases, guiding teams of 2-3 engineers",
        "Communication with customers, from user research to stakeholder management",
        "Collaboration and consultation with stakeholders during platform transitions"
      ],
    }, {
      summary1: "Square Inc",
      summary2: "Software Engineer",
      summary3: "Product frontend engineering",
      dates: "July 2017 – Sept 2020",
      bullets: [
        "Full-stack development in Ruby and Javascript (Ember) with a focus on Frontend",
        "Lead Engineer on feature-release projects guiding teams of 2-3 engineers",
        "Shadowed in project management & design for internal features"
      ],
    }, {
      summary1: "Previous Internships",
      dates: "2013 - 2016",
      bullets: [
    ...
    items: [{
      ...
      dates: "2018 - 2020",
      bullets: [
        "Organized events encouraging community building and mentorship",
